...
const PRECACHE_URLS = [
  ...
  './questions.js',
  './diary-guide.html',
  // Ballistic calculator (added in session 3 of the ballistics rollout).
  // Standalone — no dependency on diary state or auth, but every file the
  // calculator needs at boot must be precached so the calculator is fully
  // usable offline like the rest of the app.
  './ballistics.html',

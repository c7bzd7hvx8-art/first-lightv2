...
export function buildGameDealerDeclarationPDF({ entry, user }) {
  ...
  doc.setFontSize(10);
  const declText = 'I, the undersigned trained hunter, declare that I have examined this carcass and the viscera at the time of gralloching and found no abnormalities other than those noted above.';
